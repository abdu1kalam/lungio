  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        danger:
          "bg-rose-500 text-primary-foreground hover:bg-rose-500/90 border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",
        super:
          "bg-indigo-500 text-primary-foreground hover:bg-indigo-500/90 border-b-4 active:border-b-0",
        ...
        sidebarOutline:
          "bg-sky-500 text-sky-500 border-sjy-300 border-2 hover:bg-sky-500/20 transition-none",
      },
      size: {
